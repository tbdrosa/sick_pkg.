...
if("FALSE" STREQUAL "TRUE")
  set(sicktoolbox_wrapper_SOURCE_PREFIX /tmp/binarydeb/ros-jade-sicktoolbox-wrapper-2.5.3)
  set(sicktoolbox_wrapper_DEVEL_PREFIX /tmp/binarydeb/ros-jade-sicktoolbox-wrapper-2.5.3/obj-x86_64-linux-gnu/devel)
  ...
  set(sicktoolbox_wrapper_INSTALL_PREFIX /opt/ros/jade)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'sicktoolbox_wrapper' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/jade/${idir}'.  Ask the maintainer 'Chad Rockey <chadrockey@gmail.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /opt/ros/jade/lib;/opt/ros/jade/lib)
